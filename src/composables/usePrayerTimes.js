...
export function usePrayerTimes(latInput, lngInput, methodInput = 'MoonsightingCommittee', madhabInput = 'Shafi') {
  ...
  watch([lat, lng, method, madhab, currentDate], calculate, { immediate: true })
