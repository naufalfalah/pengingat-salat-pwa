  ...
  <div class="flex flex-col min-h-dvh bg-slate-50 max-w-md mx-auto">
    ...
    <nav class="shrink-0 bg-white border-t border-slate-200">
      <div class="flex">
        ...
        >
          <!-- Jadwal icon -->
          <svg v-if="tab.id === 'jadwal'" xmlns="http://www.w3.org/2000/svg" class="w-5 h-5" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2">
            <path stroke-linecap="round" stroke-linejoin="round" d="M12 8v4l3 3m6-3a9 9 0 11-18 0 9 9 0 0118 0z" />
          </svg>
          <!-- Kiblat icon -->
          <svg v-if="tab.id === 'kiblat'" xmlns="http://www.w3.org/2000/svg" class="w-5 h-5" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2">
            <path stroke-linecap="round" stroke-linejoin="round" d="M12 2C8.686 2 6 4.686 6 8c0 4.5 6 12 6 12s6-7.5 6-12c0-3.314-2.686-6-6-6zm0 8a2 2 0 110-4 2 2 0 010 4z" />
          </svg>
          <!-- Pengaturan icon -->
          <svg v-if="tab.id === 'pengaturan'" xmlns="http://www.w3.org/2000/svg" class="w-5 h-5" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2">
