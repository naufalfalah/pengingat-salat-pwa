...
<template>
  ...
  >
    <div
      v-if="show"
      class="bg-white border border-slate-200 rounded-2xl shadow-xl mx-4 mt-4 p-4"
    >
        ...
        <div class="flex items-start gap-3">
          ...
          <div class="flex-1">
            ...
            <p class="text-xs text-slate-500 mt-1 leading-relaxed">
              ...
              <svg xmlns="http://www.w3.org/2000/svg" class="inline w-3.5 h-3.5" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2"><path stroke-linecap="round" stroke-linejoin="round" d="M4 16v1a3 3 0 003 3h10a3 3 0 003-3v-1m-4-8l-4-4m0 0L8 8m4-4v12" /></svg>
              ) di Safari, lalu pilih <strong>"Add to Home Screen"</strong>
            </p>
          </div>
          <button @click="dismiss" class="text-slate-400 hover:text-slate-600 p-1 shrink-0">
      ...
      <template v-else>
        <div class="flex items-start gap-3">
          ...
          <div class="flex-1">
            ...
            <p class="text-xs text-slate-500 mt-0.5">Akses jadwal sholat lebih cepat tanpa buka browser</p>
          </div>
          <button @click="dismiss" class="text-slate-400 hover:text-slate-600 p-1 shrink-0">
            <svg xmlns="http://www.w3.org/2000/svg" class="w-4 h-4" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2">
              <path stroke-linecap="round" stroke-linejoin="round" d="M6 18L18 6M6 6l12 12" />
